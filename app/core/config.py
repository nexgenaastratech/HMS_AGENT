...
class Settings:
    ...
    GET_ALL_QUERY_REQUEST_URL: str = (
        f"{HMS_BASE_URL}/api/QueryRequest/GetAllQueryRequest"
    )
    ...
    # Database
    # TODO: Re-enable SQL Server when ready:
    # SQL_SERVER_CONN: str | None = os.getenv("SQL_SERVER_CONN")
    SQL_SERVER_CONN: str | None = None  # Temporarily forced to SQLite
    ...
    INITIAL_FOLLOWUP_DELAY_SECONDS: int = int(
        os.getenv("INITIAL_FOLLOWUP_DELAY_SECONDS", "10")
    )
